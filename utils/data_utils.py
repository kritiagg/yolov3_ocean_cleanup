...
def parse_data(line, class_num, img_size, anchors, mode, letterbox_resize):
    ...
    if not isinstance(line, list):
        ...
        full_path = os.path.abspath(dir_path + "./../data/river_data/river_cam_images/" + pic_path)
        # full_path = os.path.abspath(dir_path + "./../data/river_data/river_drone_images/data/zooniverse_trained/" + pic_path)
