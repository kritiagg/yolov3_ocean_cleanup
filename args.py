...
run_name = "river_drone_1616"

### Some paths
# train_file = './data/river_data/river_drone_images/train_riverdrone.txt'  # The path of the training txt file.
train_file = './data/river_data/river_cam_images/train_rivercam.txt'  # The path of the training txt file.
# val_file = './data/river_data/river_drone_images/test_riverdrone.txt'  # The path of the validation txt file.
val_file = './data/river_data/river_cam_images/test_rivercam.txt'  # The path of the validation txt file.
# from darknet weights
restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
# from rivercam trained model
# restore_path = './checkpoint/river_cam_1000best_model_Epoch_8_step_710_mAP_0.5770_loss_30.8642_lr_0.0001'  # The path of the weights to restore.
save_dir = './checkpoint/'+ run_name  # The directory of the weights to save.
log_dir = './data/logs' + run_name  # The directory to store the tensorboard log files.
progress_log_path = './data/progress'+ run_name+'.log'  # The path to record the training progress.
anchor_path = './data/river_data_anchors_1500.txt'  # The path of the anchor txt file.
class_name_path = './data/my_data_river.names'  # The path of the class names.

### Training releated numbers
batch_size = 6
img_size = [1024, 1024]  # Images will be resized to `img_size` and fed to the network, size format: [width, height]
